...
import CustomerSidebar2 from "./ArtsCustomerSidebar";
...
export default function CustomerMyCart2() {
  ...
  const fetchCartItemIDs = async () => {
    try {
      ...
      const cartArtworkIds = response.data.map((items) => items.artwork_id);
      setCartItemIDs(cartArtworkIds);
    } catch (error) {
            ...
            {cartItems.length === 0 ? (
              <Box display="flex" justifyContent="center" alignItems="center">
                <Typography variant="h6" color="textSecondary">
                  No artwork/s are added in the cart for now.
                </Typography>
              </Box>
            ) : (
              <Box
              ...
              >
                ...
                >
                  <Table>
                    <TableHead sx={{ backgroundColor: "#FFB6A5" }}>
                      <TableRow>
                        <TableCell
