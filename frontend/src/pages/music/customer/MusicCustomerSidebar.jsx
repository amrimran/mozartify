...
const CustomerSidebar = ({ active }) => {
  ...
  const navigationItems = [
    {
      path: "/music-customer/homepage",
      label: "Dashboard",
      icon: <Home />,
      key: "home",
    },
    {
      path: "/music-customer/library",
      label: "Libraries",
      icon: <LibraryBooks />,
      key: "library",
    },
    {
      path: "/music-customer/search",
      label: "Search",
      icon: <Search />,
      key: "search",
    },
    ...
    {
      path: "/music-customer/favorites",
      label: "Favorites",
      icon: <Favorite />,
      key: "favorites",
    },
    {
      path: "/music-customer/cart",
      label: "My Cart",
      icon: <ShoppingCart />,
      key: "cart",
    },
    {
      path: "/music-customer/inbox",
      label: "Inbox",
      icon: <Feedback />,
      isInbox: true,
      key: "inbox",
  ...
  const bottomNavigationItems = [
    {
      path: "/arts-customer/homepage",
      label: "Art InstaLogin",
      icon: <ChangeCircle />,
      key: "art",
    },
    {
      path: "/music-customer/profile",
      label: "User Profile",
      icon: <AccountCircle />,
      key: "profile",
    },
